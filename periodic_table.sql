...
INSERT INTO public.properties VALUES (1, 'nonmetal', 1.008, -259.1, -252.9, 0);
INSERT INTO public.properties VALUES (2, 'nonmetal', 4.0026, -272.2, -269, 0);
INSERT INTO public.properties VALUES (6, 'nonmetal', 12.011, 3550, 4027, 0);
INSERT INTO public.properties VALUES (7, 'nonmetal', 14.007, -210.1, -195.8, 0);
INSERT INTO public.properties VALUES (8, 'nonmetal', 15.999, -218, -183, 0);
...
INSERT INTO public.properties VALUES (9, 'nonmetal', 18.998, -220, -188.1, 0);
INSERT INTO public.properties VALUES (10, 'nonmetal', 20.18, -248.6, -246.1, 0);
...
--
-- Name: properties constraint_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT constraint_fkey FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties constraint_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT constraint_type_id_fkey FOREIGN KEY (type_id) REFERENCES public.types(type_id);
